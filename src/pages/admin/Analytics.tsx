...
const summaryStats = [
  { label: 'Total Placements', value: '223', icon: Award, change: '+15%' },
  { label: 'Average Package', value: '₹8.5 LPA', icon: TrendingUp, change: '+12%' },
  { label: 'Companies Visited', value: '45', icon: Building2, change: '+8' },
  { label: 'Placement Rate', value: '78.5%', icon: Users, change: '+5%' },
];
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="text-center p-4 rounded-lg bg-muted/50">
                <p className="text-4xl font-bold text-green-500">1,999</p>
                <p className="text-sm text-muted-foreground mt-1">Students Placed</p>
              </div>
              <div className="text-center p-4 rounded-lg bg-muted/50">
                <p className="text-4xl font-bold text-orange-500">548</p>
